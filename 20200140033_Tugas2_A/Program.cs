...
namespace _20200140033_Tugas2_A
{
    class Program
    {
        ...
        public void InsertTable()
        {
            ...
            try
            {
                conn = new SqlConnection("data source=LAPTOP-N3UNMQ7P;database=Puput;Integrated Security = TRUE");
                conn.Open();
                ...
                SqlCommand comand = new SqlCommand("insert into Kios_Mall (Id_Kios, Nama_Kios, Alamat) values ('K5B1','Kios Jamet','Kios 5 Blok 1 lantai 4')"
                    ...
                    + "insert into Transaksi (Id_Transaksi, Id_Kios, Id_Pemilik, Id_Penyewa, Waktu, TempoKontrak, Harga_Sewa, Alamat) values ('2021','K5B1','3031','4041','14 Januari 2011','1 Tahun','Rp 15.000.000','Jakarta')"
                    + "insert into Transaksi (Id_Transaksi, Id_Kios, Id_Pemilik, Id_Penyewa, Waktu, TempoKontrak, Harga_Sewa, Alamat) values ('2021','K6B2','3032','4042','15 Februari 2012','2 Tahun','Rp 30.000.000','Yogyakarta')"
                    + "insert into Transaksi (Id_Transaksi, Id_Kios, Id_Pemilik, Id_Penyewa, Waktu, TempoKontrak, Harga_Sewa, Alamat) values ('2021','K7B3','3033','4043','16 Maret 2013','3 Tahun','Rp 45.000.000','Bandung')"
                    + "insert into Transaksi (Id_Transaksi, Id_Kios, Id_Pemilik, Id_Penyewa, Waktu, TempoKontrak, Harga_Sewa, Alamat) values ('2021','K8B4','3034','4044','17 April 2014','4 Tahun','Rp 60.000.000','Surabaya')"
                    + "insert into Transaksi (Id_Transaksi, Id_Kios, Id_Pemilik, Id_Penyewa, Waktu, TempoKontrak, Harga_Sewa, Alamat) values ('2021','K9B5','3035','4045','18 Mei 2015','5 Tahun','Rp 75.000.000','Medan')", conn);
                comand.ExecuteNonQuery();
